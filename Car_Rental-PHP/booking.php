    ...
    <div class="container" style="margin-top: 65px;">
        <div class="col-md-7" style="float: none; margin: 0 auto;">
            <div class="form-area">
                <form role="form" action="bookingconfirm.php" method="POST">
                    ...
                    <h5> Choose your car type: &nbsp;
                        <input onclick="reveal()" type="radio" name="radio" value="ac" ng-model="myVar"> <b>With AC
                        </b>&nbsp;
                        <input onclick="reveal()" type="radio" name="radio" value="non_ac" ng-model="myVar"><b>With-Out
                            AC </b>
                        ...
                        <div ng-switch="myVar">
                            ...
                            <div ng-switch-when="non_ac">
                                <!-- <div class="form-group"> -->
                                <h5>Fare:
                                    <b><?php echo ("$" . $non_ac_price . "/mi and $" . $non_ac_price_per_day . "/day"); ?></b>
                                    <h5>
                                        <!-- </div>   -->
                            </div>
                        </div>
            ...
            <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
                <h6><strong>Note:</strong> You will be charged with extra <span class="text-danger">$50</span> for each
